            ...
            statsAsync.when(
              data: (stats) => LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  final int cols = width < 600 ? 2 : (width < 1000 ? 2 : 4);
                  final double cardWidth = (width - ((cols - 1) * 12)) / cols;
              ...
              data: (bundles) {
                            ...
                            if (hasOrgLocation)
                              CircleLayer(
                                circles: [
                                  CircleMarker(
                                    point: LatLng(org.latitude!, org.longitude!),
                                    radius: org.geofenceRadiusMeters.toDouble(),
                        ...
                        if (bundles.isEmpty)
                          ...
                          ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return ListTile(
                                selected: isSelected,
                                selectedTileColor: AdminColors.blueLight.withValues(alpha: 0.5),
                                contentPadding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                                leading: const CircleAvatar(
                                  backgroundColor: AdminColors.deepNavy,
                                  foregroundColor: AdminColors.yellow,
                                  child: Icon(Icons.directions_bus_rounded, size: 18),
                                ),
                                title: Text(
                                  b.bus?.busNumber ?? 'Bus Route',
                                ...
                                onTap: () {
                                  ...
                                  if (b.trip.currentLatitude != null &&
                                      b.trip.currentLongitude != null) {
                                    _mapController.move(
                                      LatLng(b.trip.currentLatitude!, b.trip.currentLongitude!),
                                      14.0,
                                    );
                                  }
                                },
                ...
                return Row(
                  ...
                  children: [
                    ...
                    Expanded(flex: 2, child: activeRoutesPanel),
                  ],
                );
              },
